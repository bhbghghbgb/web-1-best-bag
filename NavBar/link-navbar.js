...
const navbarScriptElement = document.currentScript;
const navbarScriptPath = navbarScriptElement.src;
// Get the directory of the script
const navbarScriptDirectory = navbarScriptPath.substring(
  0,
  navbarScriptPath.lastIndexOf("/")
);

document
  .getElementById("navbar-sidebar-inject")
  .insertAdjacentHTML(
    "afterbegin",
...
watchNavbarBg.active = false;
fetch(`${navbarScriptDirectory}/navbar.html`)
