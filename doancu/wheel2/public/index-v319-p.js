...
const VS = {
  ...
  WS = [
    ...
    },
    {
      ...
      component: () =>
        me(
          () => import("https://wheelofnames.com/assets/Error404-v319.js"),
          []
        ),
    },
  ],
...
US(Td, $k).then((e) => {
  ...
  return Promise[t]([
    me(
      () => import("https://wheelofnames.com/assets/i18n-v319.js"),
      __vite__mapDeps([62, 63])
    ),
    me(
      () => import("https://wheelofnames.com/assets/head-v319.js"),
      __vite__mapDeps([64, 47])
    ),
  ]).then((r) => {
